...
public class SourceFilePage extends NodePage<ISourceNode> {
     ...
     *
     * @param sourceFileNode coverage data for this source file
     * @param sourceReader   reader for the source code
     * @param tabWidth       number of character per tab
     * @param parent         optional hierarchical parent
     * @param folder         base folder for this page
