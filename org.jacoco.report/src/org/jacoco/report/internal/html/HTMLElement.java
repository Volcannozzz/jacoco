...
public class HTMLElement extends XMLElement {
     ...
     *
     * @param encoding character encoding used for output
     * @param output   output stream will be closed if the root element is closed
     ...
     *
     * @param httpequivattr value of the http-equiv attribute
     * @param contentattr   value for the content attribute
     * @return 'meta' element
     * @throws IOException in case of problems with the underlying output
     */
     ...
     *
     * @param relattr  value of the rel attribute
     * @param hrefattr value for the href attribute
     * @param typeattr value for the type attribute
     * @return 'link' element
     * @throws IOException in case of problems with the underlying output
     */
     ...
     * Creates a 'span' element.
     *
     * @param classattr value of the class attribute
     * @return 'span' element
     * @throws IOException in case of problems with the underlying output
     */
     ...
     *
     * @param classattr value of the class attribute
     * @param idattr    value of the id attribute
     * @return 'span' element
     * @throws IOException in case of problems with the underlying output
     */
     ...
     * Creates a 'a' element.
     *
     * @param hrefattr value of the href attribute
     * @return 'a' element
     * @throws IOException in case of problems with the underlying output
     */
     ...
     *
     * @param linkable object to link to
     * @param base     base folder where the link should be placed
     ...
     *
     * @param srcattr    value of the src attribute
     * @param widthattr  value of the width attribute
     * @param heightattr value of the height attribute
     * @param titleattr  value of the title and alt attribute
     * @throws IOException in case of problems with the underlying output
     */
