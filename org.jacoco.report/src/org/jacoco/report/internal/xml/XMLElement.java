...
public class XMLElement {
     ...
     * @param pubId      optional schema public identifier
     * @param system     optional schema system identifier
     * @param standalone if <code>true</code> the document is declared as standalone
     ...
     * @throws IOException in case of problems with the underlying output or if the
