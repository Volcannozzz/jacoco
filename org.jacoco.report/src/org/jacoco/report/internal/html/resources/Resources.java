...
public class Resources {
     ...
     *
     * @param root root folder of the report
     */
     ...
     *
     * @param base base folder from where the link should be created
     * @param name name of the static resource, see constants in this class
     ...
     *
     * @throws IOException if the resources can't be written to the report
     */
