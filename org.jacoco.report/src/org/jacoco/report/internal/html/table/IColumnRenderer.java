...
public interface IColumnRenderer {
     ...
     *
     * @param items all items that will be displayed in the table
     * @param total the summary of all coverage data items in the table
     ...
     *
     * @param td        the parent table cell
     * @param total     the summary of all coverage data items in the table
