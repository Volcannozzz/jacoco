...
public class DumpTask extends Task {
     ...
     *
     * @param destfile Location to write execution data to
     */
     ...
     *
     * @param append <code>true</code> if the destination file should be appended
     *               to
     */
     ...
     *
     * @param dump <code>true</code> to download execution data
     */
     ...
     *
     * @param reset <code>true</code> to reset execution data
     */
