...
class DelimitedWriter {
     ...
     *
     * @param delegate Writer to delegate all writes to
     */
     ...
     *
     * @param delegate  Writer to delegate all writes to
     * @param delimiter delimiter to use (usually a comma, tab or space)
     */
     ...
     *
     * @param fields Values to write
     * @throws IOException Error writing to the underlying writer object
     */
     ...
     * fail
     *
     * @throws IOException Error closing the underlying writer object
     */
     ...
     * is found.
     *
     * @param value String that needs escaping
