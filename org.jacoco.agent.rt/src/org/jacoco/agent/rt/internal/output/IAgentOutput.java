...
public interface IAgentOutput {
     ...
     *
     * @param options Options used to configure the agent controller
     * @param data    Execution data for this agent
     * @throws Exception in case startup fails
     */
     ...
     *
     * @throws Exception in case shutdown fails
     */
     ...
     *
     * @param reset if <code>true</code> execution data is cleared afterwards
