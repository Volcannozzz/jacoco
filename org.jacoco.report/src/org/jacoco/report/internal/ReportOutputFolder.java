...
public class ReportOutputFolder {
     ...
     *
     * @param output output for generated files
     */
     ...
     *
     * @param base base to create the relative link from
     * @param name name of the file or folder in this folder
     * @return relative link
     * @throws IllegalArgumentException if this folder and the base do not have the same root
     */
