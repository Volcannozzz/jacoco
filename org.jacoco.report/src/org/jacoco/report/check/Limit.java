...
public class Limit {
     ...
     *
     * @param entity counter entity to check
     */
     ...
     * same value.
     *
     * @param minimum allowed minimum or <code>null</code>, if no minimum should be
     *                checked
     */
     ...
     * same value.
     *
     * @param maximum allowed maximum or <code>null</code>, if no maximum should be
     *                checked
     */
