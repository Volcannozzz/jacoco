...
public class AbstractCoverageTask extends Task {
     ...
     *
     * @param append <code>true</code> to append execution data to an existing file
     */
     ...
     *
     * @param dumpOnExit <code>true</code> to write coverage data on VM termination
     */
     ...
     *
     * @param port port to bind to or connect to
     */
     ...
     * dumped to.
     *
     * @param dir dump output location
     */
